...
export default function ErrorModal({
  ...
  return (
    <div>
      {showModal && (
        <div
          className={`bg-errors-error-light border-b-[6px] border-errors-error-dark flex flex-col items-end absolute rounded-2xl ${top} left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-8 py-8  z-10`}
        >
          {/* <div
          ...
          <div className="flex gap-4">
            <ExclamationCircleIcon className="w-8 text-errors-error-dark" />
            <div>{children}</div>
          </div>
        </div>
      )}
